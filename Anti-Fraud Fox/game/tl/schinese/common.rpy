translate schinese strings:
    ...
    new "此菜单中的选项用于提升辅助功能体验。并非所有游戏都支持这些功能，且部分组合可能导致游戏无法正常游玩。这并非游戏或引擎本身的问题。若要在更换字体时获得最佳效果，请尽量保持文字大小与原始版本一致。"
    ...
    new "本程序包含多种开源许可证下的软件，包括 MIT 许可证和 GNU Lesser General Public License。完整的软件列表，以及全部源代码链接，可在{a=https://www.renpy.org/l/license}这里{/a}查看。"
