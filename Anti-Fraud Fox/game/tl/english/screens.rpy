...
translate english strings:
    ...
    old "推进对话并激活界面。"
    new "Advance dialogue and activate the interface."
    ...
    old "回到前面的对话。"
    new "Go back to previous dialogue."
    ...
    old "转到后面的对话。"
    new "Go forward to later dialogue."
    ...
    old "切换无障碍{a=https://www.renpy.org/l/voicing}自动语音{/a}。"
    new "Toggle {a=https://www.renpy.org/l/voicing}Self-Voicing{/a}."
