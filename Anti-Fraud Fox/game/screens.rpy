...
screen say(who, what):
    ...
    if not renpy.variant("small"):
        add SideImage() at side_portrait
...
screen main_menu():
    ...
    hbox:
        ...
        textbutton _("读取进度") action ShowMenu("load") style "menu_button_small"
        textbutton _("设置") action ShowMenu("preferences") style "menu_button_small"
        textbutton _("开始游戏") action Start() style "menu_button_small"
        textbutton _("关于") action ShowMenu("about") style "menu_button_small"
        textbutton _("退出游戏") action Quit(confirm=False) style "menu_button_small"
...
style menu_button_small is menu_button:
    xsize 180

style menu_button_small_text is button_text:
    size 38
    xalign 0.5
    color "#000000"
    hover_color "#555555"
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("选择后") action Preference("after choices", "toggle")
...
screen level_select():
    ...
    grid 5 3:
        ...
        for i in range(1, 16):
            ...
            if i <= persistent.unlocked:

                $ _stars = min(persistent.stars.get(str(i), 0), 3)

                button:
                    xysize (170, 94)
                    action Return(i)
                    background Solid("#000000b0")
                    hover_background Solid("#2a9df4cc")
                    ...
                    vbox:
                        ...
                        text CHAPTER_NAMES[i-1]:
                            ...
                            color "#d9e9ff"
                            outlines [(1, "#000000", 0, 0)]
                        text ("{color=#ffd54a}" + "★" * _stars + "{/color}" + "{color=#999999}" + "☆" * (3 - _stars) + "{/color}"):
                            xalign 0.5
                            size 15
                            outlines [(1, "#000000", 0, 0)]
...
## 通关结算界面
screen level_clear(chapter, stars, tip):
